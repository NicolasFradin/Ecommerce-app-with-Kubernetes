...
class OrderModel(Base):
    ...
    customer_id = Column(String, nullable=False)        # You should not use Strings as columns for a uuid, for performance issues. A Binary(16) is more recommended. String uuid takes up twice the space - 16bytes vs 32 chars
    #customer: RelationshipProperty[CustomerModel] = relationship("customers", uselist=False)
